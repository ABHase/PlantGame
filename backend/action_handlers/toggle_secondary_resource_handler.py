...
def handle_toggle_secondary_resource(action):
    ...
    if existing_plant_model:
        ...
        existing_plant_model.is_secondary_resource_production_on = not existing_plant_model.is_secondary_resource_production_on
